...
function calculateSolar() {
    ...
    var inputs = document.getElementById('mpc').getElementsByTagName('input');
    ...
    // If any input box is empty, display an alert and return early
    if (!allBoxesFilled) {
        alert("Please fill in all input boxes.");
        return;
    }

    // If all input boxes are filled, proceed with calculations
    ...
    // Display a fill-in box alert
    var alertMessage = "Based on your average daily use, you will need to purchase " + panelsNeeded + " " + panelName + " solar panels.";
    alert(alertMessage);
}
